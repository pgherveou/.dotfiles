...
/* ┌──────┬──────┬──────┬──────┬──────┬──────┐                              ┌──────┬──────┬──────┬──────┬──────┬──────┐
 * │      │      │WORD_R│      │S(UNDO│      │                              │ HOME │ END  │ PGUP │NAV_O │PASTE │      │
 * ├──────┼──────┼──────┼──────┼──────┼──────┤                              ├──────┼──────┼──────┼──────┼──────┼──────┤
 ...
 *                                                                               generated by [keymapviz] */
  [_FUNCTION] = LAYOUT(
      XXXXXXX, KC_SECRET_1,  KC_SECRET_2,  KC_SECRET_3,  KC_SECRET_4, XXXXXXX,                                         XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
