 ...
 *                                                                               generated by [keymapviz] */
  [_NAV] = LAYOUT(
      XXXXXXX, XXXXXXX, WORD_RIGHT, XXXXXXX,S(C(KC_Z)),XXXXXXX,                                           KC_HOME, KC_END,  KC_PGUP, NAV_O,  C(KC_V), XXXXXXX,
      C(KC_A), KC_LCTL, KC_LGUI, KC_LALT, KC_LSFT, XXXXXXX,                                            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX, XXXXXXX,
      C(KC_B), C(KC_Z), C(KC_X), C(KC_C), NAV_V,   WORD_LEFT, XXXXXXX, XXXXXXX,        XXXXXXX, XXXXXXX, XXXXXXX, KC_PGDN, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
 ...
 *                                                                               generated by [keymapviz] */
  [_SYM] = LAYOUT(
      KC_GRV ,   KC_1 ,   KC_2 ,   KC_3 ,   KC_4 ,   KC_5 ,                                            KC_6 ,   KC_7 ,   KC_8 ,   KC_9 , S(C(KC_V)), KC_PLUS,
