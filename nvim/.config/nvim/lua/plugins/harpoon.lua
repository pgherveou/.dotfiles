return function()
  ...
  require('utils').keymaps({
      ['n'] = {
        ...
        ['<leader>k'] = { function() require("harpoon.ui").nav_file(4) end, desc = 'Navigate to file 2' },
        ['<leader>l'] = { function() require("harpoon.ui").nav_file(4) end, desc = 'Navigate to file 3' },
        ['<leader>;'] = { function() require("harpoon.ui").nav_file(5) end, desc = 'Navigate to file 4' },
      }
})
  -- stylua: ignore end
end
