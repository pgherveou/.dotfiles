...
() {
  ...
  typeset -g __p9k_instant_prompt_param_sig=$'1.20.14\C-A5.9\C-Azsh-5.9-0-g73d3173\C-A\C-Atmux\C-A63\C-Apg%\C-A\C-A\C-A\C-A\C-A\C-A\C-A1\C-A0\C-A0\C-A\C-A%B%S%#%s%b\C-A1\C-AUTF-8\C-A\C-A\C-A0\C-A1\C-A/home/pg/.antigen/bundles/romkatv/powerlevel10k\C-A\C-A\C-A\C-A\C-A1\C-A256\C-A0\C-A\C-A#F3F99D\C-Ad h m s\C-A0\C-A5\C-A/home/pg/.p10k.zsh\C-A\C-A%F{#F1F1F0}%n%f%F{242}@%m%f\C-A\C-A%F{242}%n@%m%f\C-A#57C7FF\C-Atrue\C-Averbose\C-A\C-Acontext\C-Bdir\C-Bvcs\C-Bcommand_execution_time\C-Bnewline\C-Bvirtualenv\C-Bprompt_char\C-A\C-A\C-A \C-Atrue\C-A❮\C-A#FF5C57\C-A❯\C-A#FF5C57\C-A❮\C-A#FF5C57\C-A❮\C-A#FF6AC1\C-A❯\C-A#FF6AC1\C-A❮\C-A#FF6AC1\C-Afalse\C-A\C-Anewline\C-A\C-A\C-A \C-A242\C-A%D{%H:%M:%S}\C-Afalse\C-Aoff\C-A\C-A@\C-A1\C-A1\C-A${${${P9K_CONTENT/⇣* :⇡/⇣⇡}// }//:/ }\C-A*\C-A242\C-Avcs-detect-changes\C-Bgit-untracked\C-Bgit-aheadbehind\C-A#9AEDFE\C-A:⇣\C-A\C-A0\C-A#9AEDFE\C-A:⇡\C-A\C-A\C-A\C-A242\C-A\C-A\C-Afalse\C-A'
  local gitstatus_dir=/home/pg/.antigen/bundles/romkatv/powerlevel10k/gitstatus
  ...
  local cr=$'\r' lf=$'\n' esc=$'\e[' rs=$'\x1e' us=$'\x1f'
  local -i height=1
  local prompt_dir=/home/pg/.cache/p10k-pg
  ...
  local -A _p9k_display_k=(-2/left/command_execution_time 23 -2/left 11 2/left 31 -1/right 33 1/left/dir 19 -2/left/vcs 21 -1/left 31 1/right_frame 9 1/right 13 2/right 33 -2/right 13 2/right_frame 29 -2/right_frame 9 empty_line 1 1/left/command_execution_time 23 -1/left/prompt_char 39 2/left/prompt_char 39 -1 25 -2 5 1/left 11 -1/right_frame 29 -1/gap 35 -2/gap 15 1/left/vcs 21 2/left/virtualenv 37 1 5 1/left_frame 7 -2/left/context 17 ruler 3 2 25 -1/left_frame 27 -1/left/virtualenv 37 1/gap 15 2/gap 35 2/left_frame 27 -2/left_frame 7 1/left/context 17 -2/left/dir 19)
  local -a _p9k__display_v=(empty_line hide ruler hide 1 show 1/left_frame show 1/right_frame show 1/left show 1/right show 1/gap show 1/left/context show 1/left/dir show 1/left/vcs show 1/left/command_execution_time show 2 show 2/left_frame show 2/right_frame show 2/left show 2/right show 2/gap show 2/left/virtualenv show 2/left/prompt_char show)
  function p10k() {
    emulate -L zsh -o no_hist_expand -o extended_glob -o no_prompt_bang -o prompt_percent -o no_prompt_subst -o no_aliases -o no_bg_nice -o typeset_silent -o no_rematch_pcre
  (( $+__p9k_trapped )) || { local -i __p9k_trapped; trap : INT; trap "trap ${(q)__p9k_trapint:--} INT" EXIT }
  local -a match reply mbegin mend
